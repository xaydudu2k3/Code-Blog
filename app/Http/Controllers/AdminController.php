...
class AdminController extends Controller
{
    ...
    public function loadTagPage()
    {
        ...
        $user_profile_data = UserProfile::where('user_id', $logged_user->id)->first();
        $user_image = $user_profile_data->image ?? 'images_default.jpg';
        return view('admin.tags-page', compact('logged_user', 'user_image'));
    }
    public function loadCreateTag()
    {
        ...
        $user_profile_data = UserProfile::where('user_id', $logged_user->id)->first();
        $user_image = $user_profile_data->image ?? 'images_default.jpg';
        return view('admin.create-tag', compact('logged_user', 'user_image'));
    }
    public function loadEditTag($tag_id)
    {
        ...
        $user_profile_data = UserProfile::where('user_id', $logged_user->id)->first();
        $user_image = $user_profile_data->image ?? 'images_default.jpg';
        return view('admin.edit-tag', compact('logged_user', 'tag_data', 'user_image'));
    }
    ...
    public function loadAllPosts()
    {
        ...
        $user_profile_data = UserProfile::where('user_id', $logged_user->id)->first();
        $user_image = $user_profile_data->image ?? 'images_default.jpg';
        return view('admin.admin-post-component', compact('logged_user', 'user_image'));
    }
    ...
    public function loadUserLikePosts($user_id)
    {
        ...
        $user_profile_data = UserProfile::where('user_id', $logged_user->id)->first();
        $user_image = $user_profile_data->image ?? 'images_default.jpg';
        return view('admin.like-posts', compact('logged_user', 'user_id', 'user_image'));
    }
    public function loadUserComment($user_id)
    {
        ...
        $user_profile_data = UserProfile::where('user_id', $logged_user->id)->first();
        $user_image = $user_profile_data->image ?? 'images_default.jpg';
        return view('admin.user-comment', compact('logged_user', 'userId', 'user_image'));
    }
    public function loadGuestPosts($user_id)
    {
        ...
        $user_profile_data = UserProfile::where('user_id', $logged_user->id)->first();
        $user_image = $user_profile_data->image ?? 'images_default.jpg';
        return view('admin.guest-posts', compact('logged_user', 'user_id', 'user_image'));
    }
    ...
    public function loadCommentPage()
    {
        ...
        $user_profile_data = UserProfile::where('user_id', $logged_user->id)->first();
        $user_image = $user_profile_data->image ?? 'images_default.jpg';
        return view('admin.comment-page', compact('logged_user', 'user_image'));
    }
    public function loadUserFollowing($user_id)
    {
        ...
        $user_profile_data = UserProfile::where('user_id', $logged_user->id)->first();
        $user_image = $user_profile_data->image ?? 'images_default.jpg';
        return view('admin.user-following', compact('logged_user', 'userId', 'user_image'));
    }
}
