...
class CreatePostAdmin extends Component
{
    ...
    public function save()
    {
        ...
        $this->redirect('/admin/posts', navigate: true); //add this to ensure livewire SPA navigation
        // after save return the fields to empty and redirect user to post lists..
    }
    public function render()
    {
        return view('livewire.create-post-admin', [
            'tags' => Tag::all(),
        ]);
    }
}
